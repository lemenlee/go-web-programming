...
func tilesDB() map[string][3]float64 {
	...
	files, _ := ioutil.ReadDir("/Users/lilingfeng/Desktop/Go_Web/src/webImage/tiles")
	for _, f := range files {
		name := "/Users/lilingfeng/Desktop/Go_Web/src/webImage/tiles/" + f.Name()
